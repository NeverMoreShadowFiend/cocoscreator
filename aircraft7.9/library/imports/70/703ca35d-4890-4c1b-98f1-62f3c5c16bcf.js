...
cc.Class({
    ...
    startAction: function startAction(eindex, tindex, want) {
        ...
        for (var ei = eindex; ei < enemyindex; ei++) {
    ...
    killAllEnemy: function killAllEnemy() {
        var enemys = this.node.children;
        for (var loop = 0; loop < this.node.childrenCount; ++loop) {
